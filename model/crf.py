...
class CRF(nn.Module):
    ...
    def _calculate_PZ(self, feats, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            # partition = utils.switch(partition, cur_partition, mask[idx].
            # view(bat_size, 1).expand(bat_size, self.tagset_size)).view(bat_size, -1)
        ...
        # until the last state, add transition score for all partition
